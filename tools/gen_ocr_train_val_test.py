    ...
    for index, labelRecordInfo in enumerate(labelFileContent):
        ...
        if flag == "det":
            ...
            imagePath = os.path.join(
                dataAbsPath, "{}/{}".format(args.recImageDirName, imageName)
            )
...
def genDetRecTrainVal(args):
    ...
    for root, dirs, files in os.walk(
        "/Users/vietlq4/Downloads/AI_MayHA_Frames_annotation", topdown=True
    ):
        for dir in dirs:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--detRootPath",
        type=str,
        default="/Users/vietlq4/fpthealthcare/PaddleOCR2Pytorch/train_data/det",
        help="the path where the divided detection dataset is placed",
    )
    parser.add_argument(
        "--recRootPath",
        type=str,
        default="/Users/vietlq4/fpthealthcare/PaddleOCR2Pytorch/train_data/rec",
