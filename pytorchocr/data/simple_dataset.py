...
class SimpleDataSet(Dataset):
    def __init__(self, config, mode, logger, seed=None) -> None:
        ...
        logger.info("Initialize indexes of dataset:%s" % label_file_list)
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            outs = None
        if outs is None:
            # during evaluation, we should fix the idx to get the same results for many times of evaluation.
    ...
    #  get data line by line from 1 or many file_list 
